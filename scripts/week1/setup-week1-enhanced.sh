...
summary() {
  ...
  if [[ "${REBOOT_REQUIRED:-false}" == "true" ]]; then
    ...
    echo ""
    echo "🚀 Installation Supabase recommandée :"
    ...
    echo ""
    echo "🚀 Prêt pour Week2 - Installation Supabase :"
    echo "   ./scripts/week2/prepare-week2.sh   # Vérifications finales"
    echo "   ./scripts/week2/setup-week2-improved.sh  # Installation Supabase"
  fi
  echo "=============================================================="
